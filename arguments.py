...
def add_model_config_args(parser):
    ...
    group.add_argument('--use_sparse', action='store_true',
                       help='Use sparse operation in attention or not.')
...
def add_training_args(parser):
    ...
    group.add_argument('--tensorboard-dir', type=str, default="logs",
...
def add_data_args(parser):
    ...
    group.add_argument('--split', default='1000,0,0',
